...
import com.bihell.dice.framework.exception.BusinessException;
import com.bihell.dice.framework.exception.DaoException;
...
public class GlobalExceptionHandler {
    ...
    @ResponseStatus(HttpStatus.OK)
    public ApiResult<Boolean> unauthorizedExceptionHandler(AccessDeniedException exception) {
        printRequestDetail();
