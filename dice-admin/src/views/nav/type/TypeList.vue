  ...
  <BasicTable @register="registerTable">
    <template #form-advanceBefore>
      <router-link :to="{ name: 'PageEdit' }">
        <a-button type="primary"> <FileAddOutlined /> 新建分类</a-button>
      </router-link>
    </template>
...
<script lang="ts">
  ...
  import { getNavTypePageColumns, getNavTypePageConfig } from '../tableData';
  import { Tag, Badge } from 'ant-design-vue';
  import { postStatus, apiDeletePage } from '/@/api/blog/blog';
  import { FormOutlined, FileAddOutlined } from '@ant-design/icons-vue';
  import { useRouter } from 'vue-router';
  import { useMessage } from '/@/hooks/web/useMessage';
  import { apiNavTypeList } from '/@/api/nav/nav';
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      const [registerTable, { reload }] = useTable({
        title: '页面列表',
        api: apiNavTypeList,
        columns: getNavTypePageColumns(),
        useSearchForm: true,
        formConfig: getNavTypePageConfig(),
