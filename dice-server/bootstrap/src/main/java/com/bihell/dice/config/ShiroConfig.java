...
import com.bihell.dice.config.properties.ShiroPermissionProperties;
import com.bihell.dice.config.properties.ShiroProperties;
import com.bihell.dice.framework.shiro.cache.LoginRedisService;
import com.bihell.dice.framework.shiro.exception.ShiroConfigException;
import com.bihell.dice.framework.shiro.jwt.JwtCredentialsMatcher;
import com.bihell.dice.framework.shiro.jwt.JwtFilter;
import com.bihell.dice.framework.shiro.jwt.JwtRealm;
import com.bihell.dice.framework.shiro.service.ShiroLoginService;
...
@ConditionalOnProperty(value = {"dice.shiro.enable"}, matchIfMissing = true)
