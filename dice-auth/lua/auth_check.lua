...
if ngx.var.uri and (func.end_with(ngx.var.uri, login_path) or ngx.var.uri == icon_path or ngx.var.uri == default_icon_path or func.start_with(ngx.var.uri, static_path) or func.start_with(ngx.var.uri, default_static_path) or func.start_with(ngx.var.uri, app_js_path) or func.end_with(ngx.var.uri, health_check_path)) then
    return
end
