package com.bihell.dice.system.util;

import com.bihell.dice.system.entity.User;
import org.springframework.lang.NonNull;
import org.springframework.util.Assert;

import static com.bihell.dice.config.constant.DiceConsts.ACCESS_TOKEN_CACHE_PREFIX;
import static com.bihell.dice.config.constant.DiceConsts.REFRESH_TOKEN_CACHE_PREFIX;
import static com.bihell.dice.config.constant.DiceConsts.TOKEN_ACCESS_CACHE_PREFIX;
import static com.bihell.dice.config.constant.DiceConsts.TOKEN_REFRESH_CACHE_PREFIX;

/**
 * Security utilities. todo 待调整
 *
 * @author johnniang
 * @date 19-4-29
 */
